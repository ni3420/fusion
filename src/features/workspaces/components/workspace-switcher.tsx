    ...
    <>
      <DropdownMenu modal={false}>
        ...
        >
          ...
          <DropdownMenuItem className="flex items-center gap-2.5 px-2.5 py-2 rounded-lg bg-neutral-50 dark:bg-neutral-800 focus:bg-neutral-50 dark:focus:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 cursor-default">
              ...
              <div className="max-h-[160px] overflow-y-auto space-y-0.5 pr-0.5">
                {filteredWorkspaces.map((ws) => (
                  <DropdownMenuItem
                    ...
                    className="flex items-center gap-2.5 px-2.5 py-2 text-xs font-medium rounded-lg text-neutral-600 dark:text-neutral-400 focus:bg-neutral-50 dark:focus:bg-neutral-800 focus:text-neutral-900 dark:focus:text-neutral-100 cursor-pointer transition-colors min-w-0"
                  >
